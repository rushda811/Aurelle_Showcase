  ...
  return (
    <section className="border-b border-border">
      ...
      <header className="flex items-center justify-between gap-4 border-b border-border px-5 py-4 sm:px-8 lg:px-12">
        <a
          href="#top"
          className="font-block text-[11px] tracking-[0.35em] sm:text-xs"
        >
          Aurelle Vows
        </a>
        ...
        <nav className="flex items-center gap-5 sm:gap-8">
          ...
          <a
            href="#inquire"
            className="btn-lux btn-outline px-4 py-2 text-[10px] sm:px-5"
          >
            Inquire
          </a>
        </nav>
      ...
      <div className="grid lg:min-h-[calc(100vh-58px)] lg:grid-cols-[1.05fr_1fr]">
        ...
        {/* RIGHT — IMAGE */}
        <div className="flex items-center justify-center py-10 sm:py-12 lg:justify-end lg:py-0 lg:pr-6 xl:pr-10">
          <div className="relative w-full max-w-[520px] lg:w-[88%]">
            <img
              src={heroImg}
