...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Aurelle Vows" },
      ...
      { name: "twitter:site", content: "@aurellevows" },
    ],
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Pinyon+Script&family=Playfair+Display:ital,wght@0,400;0,500;0,600;1,400;1,500&family=Syne:wght@500;700;800&family=Tenor+Sans&display=swap",
      },
      {
        rel: "stylesheet",
        href: appCss,
